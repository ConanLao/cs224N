...
# The assignement simply doesn't like my deque implementation
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
#     def finished(self):
#         # In the end stack contains ROOT
...
#     q = deque([(idx, PartialParse(sentence)) for idx, sentence in enumerate(sentences)])
#     res = [[] for _ in range(len(sentences))]
#     while q:
#         batch = min(len(q), batch_size)
#         ins = []
#         ps = []
...
#     """Tests that a single parse step returns the expected output"""
#     pp = PartialParse([])
#     pp.stack, pp.buffer, pp.dependencies = stack, deque(buf), deps
